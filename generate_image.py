...
def run():
    ...
    try:
        ...
        base_prompt = f"""
            Generate a completely new image from scratch with a size strictly of 1024x1536 px, creating a high-performing Pinterest infographic about {subject_matter} that people save, share, and click on. This must be a fresh visual creation, explicitly avoiding eBook covers, book advertisements, product mockups, magazine covers, promotional posters, generic social media graphics, random aesthetic artwork, or title-only designs. The vertical Pinterest pin (2:3 aspect ratio) must be educational, practical, visually informative, and optimized for Pinterest engagement, featuring a professional infographic structure, strong visual hierarchy, mobile-first readability, a large attention-grabbing headline, multiple content sections, an easy-to-scan design, a Pinterest-native appearance, clean spacing, and premium visual balance. The layout must contain a compelling Pinterest-style headline based on the topic, a short explanatory subtitle, 3–5 insight sections, mistakes, habits, signs, lessons, or tips relevant to the topic, visual connectors such as arrows, icons, dividers, or flow elements, a transformation-focused takeaway section, and a subtle call-to-action section. The design must visually explain the topic without random decorative imagery, instead using realistic scenes, illustrations, symbols, psychology-based visual metaphors, and meaningful graphics directly connected to the topic, such as overthinking, mental clutter, brain activity, focus, productivity, mindfulness, journaling, phone addiction, distraction, daily habits, decision making, stress, mental clarity, or self-improvement routines, ensuring the imagery immediately communicates the topic. The style must be a modern psychology infographic within the self-improvement niche with a premium Pinterest aesthetic, using a soft neutral color palette, strategic accent colors, clean white space, high-end digital publication quality, minimal clutter, and visually engaging information design. The typography should feature a large Pinterest-style headline, bold readable fonts, high contrast text, clear section labels, mobile-friendly readability, and be optimized for quick scanning. The final output must be an ultra-detailed Pinterest infographic with a highly professional layout, realistic design composition, premium content marketing graphic, conversion-focused visual hierarchy, Pinterest viral pin style, polished typography, educational infographic format, and high engagement potential.
            """
