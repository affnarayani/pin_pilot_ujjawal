...
def run():
    ...
    try:
        ...
        TOPIC / SUBJECT MATTER: {subject_matter}
        PRIMARY OBJECTIVE: Design an authoritative, cinematic, emotionally intelligent, and premium horizontal blog hero image that immediately establishes credibility, communicates the core psychological message of the article, and captures attention on both desktop and mobile devices.
        ...
        IMPORTANT: Generate ONLY the final image-generation prompt.
        Do NOT explain your reasoning.
        Do NOT output markdown.
        Do NOT output design notes.
        Do NOT include titles, labels, or commentary.
        IMAGE FORMAT & LAYOUT: Blog Post Hero Image / Website Header
        Aspect Ratio: 16:9
        ...
        SUBJECT INTERPRETATION: The image must visually represent the specific psychological concept behind the article—not merely the broader category of mental wellness.
        ...
        Do NOT repeatedly use: meditation poses, yoga poses, lotus position, mountains, lakes, zen gardens, temples, waterfalls, glowing spiritual imagery unless the article specifically discusses meditation, mindfulness practice, or similar topics.
        ...
        VISUAL STORYTELLING: The image should communicate the article's psychological idea before the reader even begins reading.
        ...
        Examples: Overthinking → A person standing beside a rain-covered window lost in thought.
        Burnout → An empty office illuminated by late evening sunlight.
        Loneliness → A single chair beside a large window.
        Emotional Healing → Bandaged hands gently holding a warm cup of tea.
        Confidence → Someone walking confidently through early morning light.
        Letting Go → Open hands releasing autumn leaves into the wind.
        Self-Awareness → A thoughtful reflection in a mirror with subtle symbolism.
        Growth → A quiet forest path disappearing into soft morning light.
        Habits → An organized desk with a journal showing gradual progress.
        Choose concepts naturally based on the article rather than copying these examples.
        VISUAL STYLE: Premium digital editorial photography.
        Think: Medium editorial covers, New York Times long-form essays, Apple editorial campaigns, Kinfolk magazine, Psychology Today, Calm, Headspace, High-end wellness publications.
        ...
        PEOPLE: If including people:
        Randomize naturally across articles: gender, age, ethnicity, hairstyle, clothing, body type.
        ...
        COMPOSITION: Use professional editorial composition.
        ...
        ENVIRONMENT VARIETY: Across different articles intentionally vary: interiors, architecture, nature, urban settings, weather, seasons, time of day, camera angle, focal length, perspective, emotional atmosphere.
        Avoid producing hero images that feel visually repetitive across multiple blog posts.
        OBJECTS & SYMBOLISM: Meaningful objects may be used as the primary subject whenever appropriate.
        Examples include: journals, books, coffee mugs, empty benches, windows, reflections, doorways, pathways, trees, leaves, light rays, shadows, mirrors, clocks, handwritten notes, candles, quiet workspaces, natural textures.
        Use symbolism subtly rather than making it obvious.
        COLOR PALETTE: Modern premium self-improvement aesthetic.
        Use: warm creams, soft beiges, muted olives, deep charcoal, earthy neutrals, elegant grays.
        ...
        Avoid: neon colors, oversaturation, excessive gradients, loud color combinations, cheap stock-photo color grading.
        MOOD: Create an atmosphere that feels: calm, intelligent, reflective, hopeful, emotionally authentic, quietly optimistic.
        The mood should support the article rather than overpower it.
        NEGATIVE REQUIREMENTS: Do NOT generate: cluttered compositions, generic stock-photo poses, floating brains, glowing heads, human silhouettes filled with galaxies, abstract energy waves, floating geometric shapes, cheesy motivation imagery, businessman looking at mountains, person with arms stretched toward sunrise, repetitive meditation scenes, random yoga poses, zen stone stacks unless directly relevant, unrealistic facial anatomy, distorted hands, AI-generated gibberish text, watermarks, logos, interface elements, captions, typography inside the image.
        CONSISTENCY: Every generated hero image should feel like part of the same premium publication while remaining visually unique.
